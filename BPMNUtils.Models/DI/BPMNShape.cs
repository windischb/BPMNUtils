namespace BPMNUtils.Models.DI
{
    public class BPMNShape : LabeledShape, ILabeled
    {
        ...
        public virtual bool IsMarkerVisible { get; set; }

        public virtual bool IsMessageVisible { get; set; }

        public virtual ParticipantBandKind ParticipantBandKind { get; set; }

        public virtual string ChoreographyActivityShape { get; set; }
    }
}
